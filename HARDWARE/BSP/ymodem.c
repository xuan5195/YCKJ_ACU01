...
*	修改记录 :
*		版本号  日期         作者                说明
*		V1.0    2015-03-05  Eric2013   整理自ST官方的串口IAP工程里面函数
*
...
//										FLASH_If_Erase(APPLICATION_ADDRESS);
								...
								else
								{
									...
									//if(bsp_WriteCpuFlash(flashdestination, (uint8_t*) ramsource, packet_length)==0)
									/* 将接收到的数据编程到flash */
